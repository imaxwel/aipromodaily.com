...
import secuImage from "../../../../public/images/secu.svg";export const featureTabs: Array<{
	...
	},
	{
		...
		description:
			"${process.env.SITE_DOMAIN_NAME} provides not only psychological counseling but also warm companionship on your emotional growth journey. We help you find hope in despair and discover the strength to grow through difficulties.",
		stack: [],
		image: secuImage,
		imageBorder: false,
		highlights: [
			...
			<div className="container max-w-5xl">
				<div className="mx-auto mb-6 lg:mb-0 lg:max-w-5xl lg:text-center">
					...
					<p className="mt-6 text-balance text-lg opacity-50">
						When feeling lost, chat your way back at ${process.env.SITE_DOMAIN_NAME?.toUpperCase()}. Our AI counselors are available 24/7 to help you overcome challenges and rediscover meaning in life.
					</p>
				</div>
